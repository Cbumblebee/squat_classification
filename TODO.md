...
Pro-tip for an Arch user: Use IPython or a Jupyter Notebook (if you have it in your .venv) for this exploratory phase.
It lets you inspect the tensors easily without re-running the whole script every time.
